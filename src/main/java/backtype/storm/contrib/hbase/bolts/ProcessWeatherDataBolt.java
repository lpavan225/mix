...
public class ProcessWeatherDataBolt extends BaseRichBolt {
	...
	public void execute(Tuple tuple) {
	    ...
	    collector.emit(new Values(words[0],words[1],words[2],words[3],words[4], words[5]));
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declare(new Fields("shortid", "Date", "Precip","Max_Air_Temp","Min_Air_Temp", "Avg_Air_Temp"));
